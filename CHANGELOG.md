...
Generated by [Commitizen](https://commitizen-tools.github.io/commitizen/) from the
Conventional Commits in each release — do not edit by hand. This project adheres
to [Semantic Versioning](https://semver.org/).

See the README's Upstream sync section for which changes came from
[substrate](https://github.com/superlinear-ai/substrate) and which are ours.
